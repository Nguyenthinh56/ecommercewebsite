...
def categories(request):
    ...
    active_categories = request.GET.get('categories','')
    if active_categories:
        products = Product.objects.filter(categories__slug = active_categories)
    context = {'user_not_login':user_not_login,'user_login':user_login,'categories':categories,'products':products,'active_categories':active_categories}
...
def search(request):
    ...
    categories = Categories.objects.filter(is_sub = False)
    context = {'user_not_login':user_not_login,'user_login':user_login,'categories':categories,'searched':searched,'keys':keys,'products': products,'cartItems':cartItems}
